...
const media = [
  {
    ...
    videoSrc: ["./media/video/bzr_quevedo.mp4", "./media/video/bzr_quevedo.webm"],
    audioSrc: ["./media/music/bzr_quevedo.mp3", "./media/music/bzr_quevedo.wav"],
  ...
  },
  {
    ...
    videoSrc: ["./media/video/bzr_shakira.mp4", "./media/video/bzr_shakira.webm"],
    audioSrc: ["./media/music/bzr_shakira.mp3", "./media/music/bzr_shakira.wav"],
  ...
  },
  {
    ...
    videoSrc: ["./media/video/bzr_duki.mp4", "./media/video/bzr_duki.webm"],
    audioSrc: ["./media/music/bzr_duki.mp3", "./media/music/bzr_duki.wav"],
  ...
  },
  {
    ...
    videoSrc: ["./media/video/bzr_heladio.mp4", "./media/video/bzr_heladio.webm"],
    audioSrc: ["./media/music/bzr_heladio.mp3", "./media/music/bzr_heladio.wav"],
    poster: "./media/poster/poster_heladio.png",
  },
];

export { mediaActions, media };
