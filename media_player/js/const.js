...
const media = [
  {
    ...
    videoSrc: ["./media/video/bzr_quevedo.mp4"],
    audioSrc: ["./media/music/bzr_quevedo.mp3"],
  ...
  },
  {
    ...
    videoSrc: ["./media/video/bzr_shakira.mp4"],
    audioSrc: ["./media/music/bzr_shakira.mp3"],
  ...
  },
  {
    ...
    videoSrc: ["./media/video/bzr_duki.mp4"],
    audioSrc: ["./media/music/bzr_duki.mp3"],
  ...
  },
  {
    ...
    videoSrc: ["./media/video/bzr_heladio.mp4"],
    audioSrc: ["./media/music/bzr_heladio.mp3"],
